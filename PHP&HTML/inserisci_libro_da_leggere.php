...
<head>
	<title>Inserisci libro da leggere</title>
...
<body>
	...
	<div class="breadcrumb">
		<p class="path">Ti trovi in: <span xml:lang="en"><a href="index.html">Home</a></span>/<a href="amministrazione.html">Amministrazione </a>/Inserisci libro da leggere</p>
...
if (!(mysqli_stmt_num_rows(mysqli_multi_query($db,"SELECT * FROM `libro` WHERE isbn='$isbn'"))))
{echo '<br><h1>Libro non presente';}
else{
$insert="INSERT INTO `DaLeggere` VALUES ('$email','$isbn')";
