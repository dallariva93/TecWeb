...
<head>
	<title>Inserisci scrittore</title>
...
<div class="breadcrumb">
	...
	<div class="breadcrumb">
		<p class="path">Ti trovi in: <span xml:lang="en"><a href="index.html">Home</a></span>/<a href="amministrazione.html">Amministrazione </a>/Inserisci scrittore</p>
		<div class="searchform">
			<form action="action_page.php">
				<fieldset>
					<input type="text" name="googlesearch" id="search" />
